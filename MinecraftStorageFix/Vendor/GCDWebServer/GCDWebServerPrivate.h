/*
 ...
 Vendored subset for MinecraftStorageFix: WebDAV, URLEncoded form,
 and StreamedResponse headers are omitted. Multi-part forms are included
 for folder-style world uploads.
 */
...
/**
 *  All GCDWebServer headers (minimal vendored set).
 */
